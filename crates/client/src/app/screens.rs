...
pub(in crate::app) fn render_uno_mode_dropdown(
    commands: &mut Commands,
    root: Entity,
    parent: Entity,
    rules: UnoRuleSet,
    ...
    let mode_label = |mode| match mode {
        leocard_uno::Mode::Classic => "UNO",
        leocard_uno::Mode::NoMercy => "No Mercy",
        leocard_uno::Mode::Flip => "UNO FLIP",
    };
