...
pub(super) struct StartGameSeatTransitionVisual {
    pub(super) movement: f32,
}

pub(super) fn start_game_seat_transition_visual(elapsed: f32) -> StartGameSeatTransitionVisual {
...
pub(super) fn animate_start_game_seat_transition(
    time: Res<Time>,
