...
pub(super) const TURN_BORDER_THICKNESS: f32 = 2.6;
const TURN_BORDER_OUTSET: f32 = TURN_BORDER_THICKNESS * 0.5 + 0.75;

#[derive(AsBindGroup, Asset, TypePath, Debug, Clone)]
pub(super) struct TurnBorderMaterial {
...
#[derive(Component)]
pub(super) struct TurnBorderTrace {
...
pub(super) struct TurnBorderAnimationKey {
    game: GameKind,
    match_id: MatchId,
    player: PlayerId,
}
...
impl TurnBorderAnimationKey {
    pub(super) fn new(game: GameKind, match_id: MatchId, player: PlayerId) -> Self {
        Self {
            game,
            match_id,
            player,
...
pub(super) struct TurnBorderAnimationState {
    elapsed: HashMap<TurnBorderAnimationKey, f32>,
}

pub(super) fn add_turn_border_trace(
...
pub(super) fn turn_border_visible_interval(elapsed: f32, perimeter: f32) -> (f32, f32) {
...
pub(super) fn animate_turn_border_traces(
    time: Res<Time>,
