...
pub(super) fn special_competition_key(
    lead: &ShengjiClassifiedPlay,
...
pub fn category(card: ShengjiCard, trump: ShengjiTrump) -> Category {
...
pub fn strength(card: ShengjiCard, trump: ShengjiTrump) -> u8 {
    trump.strength(card)
}
...
pub(super) fn longest_quad_run(quads: &[QuadUnit]) -> Option<Vec<usize>> {
...
pub(super) fn longest_triple_run(triples: &[TripleUnit]) -> Option<Vec<usize>> {
    longest_strength_run(
...
pub(super) fn longest_pair_run(pairs: &[PairUnit]) -> Option<Vec<usize>> {
    longest_strength_run(
...
pub(super) fn longest_strength_run(strengths: &[u8], maximum: usize) -> Option<Vec<usize>> {
