...
pub(super) fn no_mercy_game(player_count: u8) -> GameState {
...
pub(super) fn flip_rules() -> UnoRuleSet {
    UnoRuleSet {
...
pub(super) fn flip_card(color: UnoColor, face: UnoFace) -> UnoCard {
    UnoCard::paired(
...
pub(super) fn deck_with_prefix(prefix: &[UnoCard]) -> Vec<UnoCard> {
...
pub(super) fn card(color: UnoColor, face: UnoFace, copy: u8) -> UnoCard {
    match face {
