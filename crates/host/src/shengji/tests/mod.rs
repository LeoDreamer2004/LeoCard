...
use leocard_protocol::{
    ClientCommand, GameCommand, JoinRequest, PlayerGameProfiles, ProfileId, ReconnectToken, SeatId,
    ServerEvent, join_identity_payload,
};
use leocard_shengji::{Category, ShengjiRank, ShengjiSuit, build_deck_for};
...
fn started_session() -> (ShengjiSession, [ConnectionId; 4], ShengjiCard) {
    started_session_with_rules(ShengjiRuleSet::default())
}

fn started_session_with_rules(
